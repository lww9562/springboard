package org.springboard.board.controllers.members;

import lombok.RequiredArgsConstructor;
import org.springboard.board.commons.validators.MobileValidator;
import org.springboard.board.commons.validators.PasswordValidator;
	...
	public void validate(Object target, Errors errors) {
		...
		if (agrees != null && agrees.length > 0) {
			for (boolean agree : agrees) {
				if (!agree) {
					errors.reject("Validation.joinForm.agrees");
					break;
				}
			}
		} else if(agrees == null) {

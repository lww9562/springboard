...
import org.springboard.board.entities.QFileInfo;
...
public class FileInfoService {
	...
	public String getFilePath(Long id, String extension) {
		String directoryPath = fileUploadPath + getDirectory(id);
		...
		String path = directoryPath + File.separator + id;
	...
	public String getFileUrl(Long id, String extension) {
		String url = request.getContextPath() + "/uploads/" + getDirectory(id) + "/" + id;
		if(extension != null || !extension.isBlank()) {
			url += "." + extension;
		}
